...
@register_ehr("mimicived")
class MIMICIVED(EHR):
    def __init__(self, cfg):
        super().__init__(cfg)

        # self.ehr_name = "mimicived"
        ...
        self._icustay_fname = "ed/edstays" + self.ext
        ...
        if cfg.use_ed:
            self.tables = [
                ...
                },
                {
                    ...
                    "timeoffsetunit": "abs",
                    "exclude": ["subject_id"],
                    "numeric": ['temperature', 'heartrate', 'resprate', 'o2sat', 'sbp', 'dbp']
                },
            ]
    ...
    def make_compatible(self, icustays):
        ...
        icustays["LOS"] = (icustays["OUTTIME"] - icustays["INTIME"]) / pd.Timedelta(days=1)
